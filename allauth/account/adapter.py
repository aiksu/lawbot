...
class DefaultAccountAdapter(object):
    ...
    def get_login_redirect_url(self, request):
        ...
        url = getattr(settings, "zubmill.com/wp/profile", None)
        if url:
    ...
    def is_open_for_signup(self, request):
        ...
        """
        # return True
        if settings.ZUBMILL_TYPE=='RU':
            return True
        elif settings.ZUBMILL_TYPE == 'EN':
            return False
        elif settings.ZUBMILL_TYPE == 'DEV':
            return True
        else:
            return False
    ...
    def save_user(self, request, user, form, commit=True):
        ...
        if full_name:
            user_field(user, 'first_name', full_name)
